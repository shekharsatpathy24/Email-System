...
$(function() {
    ...
    $(document).ready(function(){
        ...
        $("#myTable td").click(function() {   
            window.location.href=('rownum.php'); 
        });
    });
...
<div class="navbar">
  ...
  <a>Inbox</a>
	...
	<div class="sidenav">
  <a href="recievedmail.php">Recieved Mails</a>
  <a>Sent Mails</a>
</div>
 <div class="coupon">
  <div class="container">
  ...
  $pw=$_POST['pw'];
  $fid="Empty!";
  $sql="select * from mail,user_login where user_login.Username='$_SESSION[userid]' and user_login.Username=mail.sender order by timestamp desc";
  mysql_select_db('school');
  
  $result=mysql_query($sql,$conn);
  $count=mysql_num_rows($result);
  echo "<h3>Sent Mail</h3>";
