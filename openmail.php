...
<div class="coupon">
  ...
  $sql=("select mail.timestamp,mail.sender,mail.reciever,mail.subject,mail.message,mail.filename,mail.filepath,mail.file_id from mail,user_login where user_login.Username='$_SESSION[userid]' and mail.sender='$_SESSION[userid]'   order by timestamp desc limit $_SESSION[rownum],1");
